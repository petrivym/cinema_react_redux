...
export const getTopRatedFilms = (page) => async (dispatch) => {
    try {
        ...
        const {data: {total_pages, results: filmInfo}} = await setTopRatedFilms('uk-UA', page);
...
export const setTopRatedFilms = (filmInfo, total_pages) => ({
    type: SET_TOP_RATED_FILMS,
    payload: {filmInfo, total_pages}
});
